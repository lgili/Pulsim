#include "spicelab/fmu/fmu_export.hpp"
#include <algorithm>
#include <chrono>
#include <ctime>
#include <fstream>
...
void FmuExporter::build_model_description(const Circuit& circuit,
    ...
    model_desc_.description = options_.description.empty() ?
        "SpiceLab circuit simulation model" : options_.description;
...
std::string FmuExporter::generate_fmu_header() {
    ...
    h << "// Generated by SpiceLab FMU Exporter\n\n";
...
std::string FmuExporter::generate_fmu_source() {
    ...
    src << "// Generated by SpiceLab FMU Exporter\n\n";
...
bool FmuExporter::write_source_files(const std::filesystem::path& fmu_dir) {
    try {
        ...
        // Copy FMI headers (would need to be bundled with SpiceLab)
