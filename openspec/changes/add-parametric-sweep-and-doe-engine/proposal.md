...
## What Changes
- Introduce a formal capability contract for: batch parametric sweep and DOE orchestration with structured experiment manifests and reproducible runs
...
## Impact
- Affected specs: python-bindings, benchmark-suite, netlist-yaml
- Affected code: python/pulsim/*, python/bindings.cpp, benchmarks/*, core/src/v1/yaml_parser.cpp
