...
## What Changes
- Introduce a formal capability contract for: nonlinear magnetic core models (saturation, hysteresis, frequency-dependent core loss) for inductors/transformers
...
## Impact
- Affected specs: device-models, netlist-yaml, kernel-v1-core, benchmark-suite
- Affected code: core/include/pulsim/v1/components/*, core/src/v1/yaml_parser.cpp, core/src/v1/simulation*.cpp, benchmarks/*
