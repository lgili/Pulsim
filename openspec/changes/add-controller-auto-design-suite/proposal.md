...
## What Changes
- Introduce a formal capability contract for: controller auto-design/tuning assistants for common converter topologies (PI/PID current and voltage loops)
...
- Affected code: python/pulsim/*, core/src/v1/simulation_periodic.cpp, benchmarks/*
