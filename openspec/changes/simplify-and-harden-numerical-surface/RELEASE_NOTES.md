# Release Notes — `simplify-and-harden-numerical-surface`

> **Draft.** This document covers PR #13 of the
> `simplify-and-harden-numerical-surface` OpenSpec change. Final
> release notes for v0.11 will fold these in alongside other landed
> work.
