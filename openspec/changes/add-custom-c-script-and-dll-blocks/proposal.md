...
## What Changes
- Introduce a formal capability contract for: user-defined functional blocks implemented in C code or dynamically loaded libraries with deterministic I/O contracts
...
- Affected code: core/include/pulsim/v1/runtime_circuit.hpp, core/src/v1/simulation.cpp, core/src/v1/yaml_parser.cpp, python/bindings.cpp
