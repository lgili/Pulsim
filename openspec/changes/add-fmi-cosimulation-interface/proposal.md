...
## What Changes
- Introduce a formal capability contract for: FMI-compatible co-simulation interfaces for external tool coupling and multi-domain workflows
...
## Impact
- Affected specs: python-bindings, kernel-v1-core, netlist-yaml
- Affected code: python/pulsim/*, core/src/v1/simulation.cpp, adapters/fmi/*
