...
## What Changes
- Introduce a formal capability contract for: averaged converter modeling mode with consistent mapping to switching models for fast control-loop design iterations
...
- Affected code: core/src/v1/simulation.cpp, core/src/v1/yaml_parser.cpp, python/bindings.cpp, benchmarks/*
