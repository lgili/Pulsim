...
if TYPE_CHECKING:
    from .client import SpiceLabClient, WaveformStream, AsyncWaveformStream
...
class StreamingPlot:
    ...
    Example:
        >>> from spicelab.grpc import SpiceLabClient
        >>> from spicelab.grpc.widgets import StreamingPlot
        >>>
    ...
    def __init__(
        ...
        Args:
            client: Connected SpiceLabClient instance.
...
class InteractivePlot:
    ...
    Example:
        >>> from spicelab.grpc.widgets import InteractivePlot
        >>>
...
def plot_waveforms(
    ...
    **kwargs,
    ...
    Args:
        client: SpiceLabClient instance.
