"""SpiceLab gRPC client implementation."""
...
class SpiceLabClient:
    """gRPC client for SpiceLab simulation server.
    ...
    def connect(self) -> None:
        ...
        logger.info(f"Connected to SpiceLab server at {self._address}")
    ...
    def close(self) -> None:
        ...
        if self._channel is not None:
            ...
            self._channel = None
            self._stub = None
            logger.info("Disconnected from SpiceLab server")

    def __enter__(self) -> SpiceLabClient:
    ...
    async def aconnect(self) -> None:
        ...
        logger.info(f"Async connected to SpiceLab server at {self._address}")
    ...
    async def aclose(self) -> None:
        ...
        if self._async_channel is not None:
            ...
            logger.info("Async disconnected from SpiceLab server")

    async def __aenter__(self) -> SpiceLabClient:
