...
_EXAMPLES: dict[str, str] = {
    ...
    "bode": """\
        import math, numpy as np, pulsim.v2 as p
...
def catalog(category: str | None = None) -> None:
    """Print the pulsim.v2 catalogue, optionally filtered by category.
...
def tour() -> None:
    """Print a one-page walking tour of pulsim.v2 — read top to bottom."""
    print("""
=============================================================================
 pulsim.v2 — one-page tour
=============================================================================
