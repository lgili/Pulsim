...
[`00_buck_pulsim_validation.ipynb`](00_buck_pulsim_validation.ipynb)
for an executed notebook that builds the same buck topology in
Pulsim, runs the switched transient, and overlays it against the
small-signal prediction.
