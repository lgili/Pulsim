"""Reference PSIM validation data — Maia PFC FR — Compressor.

Source: Nidec internal document
  ``0000083978 - Maia PFC FR - Simulation v0.4 (1).xlsx``
  (Edson Jeske, project ID Maia PFC Full Range,
   "Design Deliverable — Power Stage Simulation").

Three operating points were simulated in PSIM at the schematic
(V0rD) level. This module re-publishes the numerical results as
Python data so the Pulsim port (see
``maia_pfc_compressor_pulsim_validation.py``) can target them
