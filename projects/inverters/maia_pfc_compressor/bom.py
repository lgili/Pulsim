"""Maia PFC FR — Bill of Materials (BoM) for the power stage.

Each entry mirrors a real part on the V0rD prototype, with the
parameters the Pulsim builder needs to mirror PSIM's behaviour.

Sources:
  * 0000083978 - Maia PFC FR - Simulation v0.4 (1).xlsx, sheet
    ``1-Modeling`` (component values) + ``4-Design Margins Maia FR``
    (datasheet snapshots).
"""
