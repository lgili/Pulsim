...
struct ResultSnapshot {
    spicelab::SimulationResult result;
...
public:
    ...
    void push_sample(double time, const spicelab::Vector& state);
...
public:
    ...
    std::optional<spicelab::SimulationOptions> get_options(const std::string& session_id) const;
