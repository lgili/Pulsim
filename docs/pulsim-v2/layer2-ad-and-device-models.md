...
// pulsim/v2/models/device_model.hpp
...
// pulsim/v2/models/resistor.hpp        — linear passive (Ohm's law)
// pulsim/v2/models/voltage_source.hpp  — constraint (kind = Source)
// pulsim/v2/models/ideal_diode.hpp     — nonlinear (smooth-blend)
```
