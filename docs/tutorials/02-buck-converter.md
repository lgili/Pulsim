...
**Reference YAML:** [`examples/buck.yaml`](https://github.com/lgili/Pulsim/blob/main/examples/buck.yaml).
...
[`examples/buck.yaml`](https://github.com/lgili/Pulsim/blob/main/examples/buck.yaml) declares the same circuit + PWM with:
