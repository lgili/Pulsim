...
**Reference YAML:** [`examples/rlc_step_response.yaml`](https://github.com/lgili/Pulsim/blob/main/examples/rlc_step_response.yaml) (also contains an inductor — for pure RC see the snippet below).
...
- **Move to YAML.** Translate the same circuit to `examples/rlc_step_response.yaml` — the test `core/tests/showcases/test_rlc_step_response.cpp` already covers this end-to-end.
