...
**Reference YAML:** [`examples/v2/boost_realistic_igbt.yaml`](https://github.com/lgili/Pulsim/blob/main/examples/v2/boost_realistic_igbt.yaml).
...
- `core/include/pulsim/v2/` — read the layer headers; they're written to be readable.
- `openspec/changes/pulsim-v2-*` — every design decision, in chronological order.
